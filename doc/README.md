...
* Injector - це основний механізм. Angular створює для вас інжектор для всього програми під час процесу початкового завантаження і додаткові інжектори в міру необхідності.
